...
colorIcon.addEventListener("click", ()=>{
    ...
    colorIcon.closest(".list-container").children[2].classList.toggle("white-bcg");
    colorIcon.closest(".list-container").children[1].classList.toggle("white-bcg");
    colorIcon.closest(".list-container").children[3].classList.toggle("white-bcg");
...
inputRef.addEventListener("keypress", (event1)=>{
    if (event1.key === "Enter" && inputRef.value !== "") {
...
//# sourceMappingURL=index.b7e9aa23.js.map
